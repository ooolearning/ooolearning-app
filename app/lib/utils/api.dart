...
import 'package:ooolearning_app/exceptions/http_entity_not_found_exception.dart';
import 'package:ooolearning_app/exceptions/http_missing_authorization_exception.dart';
...
class Api {
  ...
  Uri getUri(String path) => Uri.https(authority, path);
